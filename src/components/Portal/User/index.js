        ...
        const menu = (
            <Menu>
                <Menu.Item key="userProfile">
                    <Link to='/portal/profile_page' style={{ textDecoration: 'none' }}>
                        <Icon type='user' />&nbsp;{this.props.user.name}
                    </Link>
                </Menu.Item>
                <Menu.Item key="accountSettings">
                    <Link to='/portal/accountsettings' style={{ textDecoration: 'none' }}>
                        <Icon type="setting" />
                        &nbsp;account settings
                    </Link>
                </Menu.Item>
                ...
                <Menu.Item key="logout">
                    <a href="" onClick={(e) => { this.handleLogout(e) }} style={{ textDecoration: 'none' }}>
