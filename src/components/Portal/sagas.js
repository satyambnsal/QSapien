...
import {GET_PUBLIC_CONTACTS,SET_PUBLIC_CONTACTS, ADD_CONTACT_TO_FRIEND_LIST, GET_FRIEND_LIST} from './constants';
...
export function* contactRequestWatcher(){
    while(true){
        const action=yield take([GET_PUBLIC_CONTACTS,ADD_CONTACT_TO_FRIEND_LIST,GET_FRIEND_LIST]);
