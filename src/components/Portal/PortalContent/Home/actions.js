import {GET_CHALLENGES,SET_CHALLENGES, SOLVE_CHALLENGE_REQUESTING, SET_SOLVE_CHALLENGE_RESULT, RESET_SOLVE_CHALLENGE, GET_ASKED_CHALLENGES, SET_ASKED_CHALLENGES, GET_SOLVED_CHALLENGES,
     SET_SOLVED_CHALLENGES, SEND_CHALLENGE, SET_SEND_CHALLENGE_RESULT} from './constants';

export const sendChallenge=(values)=>({
    type:SEND_CHALLENGE,
    values
});
export const setSendChallengeResult=(result)=>({
    type:SET_SEND_CHALLENGE_RESULT,
    result
})
